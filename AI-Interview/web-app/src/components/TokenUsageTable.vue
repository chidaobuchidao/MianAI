...
<style scoped>
.scope-note { margin: 0 0 12px; color: var(--text-muted); font-size: 12px; line-height: 1.7; }
.details { margin-top: 30px; } .tabs { display: inline-flex; flex-wrap: wrap; gap: 4px; padding: 4px; margin-bottom: 16px; background: var(--bg-surface); border: 1px solid var(--border-light); border-radius: var(--radius-full); } .tabs button { display: inline-flex; align-items: center; gap: 8px; min-height: 36px; border-radius: var(--radius-full); padding: 0 17px; color: var(--text-muted); font-size: 13px; cursor: pointer; } .tabs button[aria-selected=true] { background: var(--bg-dark); color: white; }
.table-tools { background: var(--bg-paper); display: flex; align-items: center; flex-wrap: wrap; gap: 10px; padding: 9px; border: 1px solid var(--border-medium); border-radius: 12px; margin-bottom: 16px; } select, input { height: 36px; font: inherit; font-size: 12px; color: var(--text-main); background: var(--bg-paper); border: 1px solid var(--border-medium); border-radius: 8px; padding: 0 12px; } .search { position: relative; display: flex; align-items: center; } .search svg { position: absolute; left: 11px; color: #7d8490; } .search input { padding-left: 34px; width: 200px; } .row-count { margin-left: auto; padding-right: 8px; font-size: 12px; color: var(--text-muted); }
.table-scroll { background: var(--bg-paper); overflow: auto; max-height: 480px; border: 1px solid var(--border-medium); border-radius: 12px; } table { border-collapse: collapse; width: 100%; min-width: 760px; font-size: 13px; text-align: right; font-variant-numeric: tabular-nums; } th, td { padding: 16px 22px; border-bottom: 1px solid var(--border-light); } thead th { position: sticky; top: 0; background: var(--bg-paper); color: var(--text-muted); font-weight: 500; font-size: 12px; white-space: nowrap; } th:first-child { text-align: left; } tbody th { font-weight: 500; color: var(--text-main); max-width: 320px; overflow-wrap: anywhere; } tbody td { color: var(--text-muted); } tbody tr:hover { background: var(--bg-surface); } tbody tr:last-child :is(th, td) { border-bottom: 0; } td.total { color: var(--text-main); font-weight: 550; } .warning { color: #98631a; background: #fff7e8; border-radius: 4px; padding: 3px 7px; } td.empty { text-align: center; padding: 40px 20px; }
:is(button, input, select, [tabindex]):focus-visible { outline: 2px solid var(--accent); outline-offset: 2px; } .sr-only { position: absolute; width: 1px; height: 1px; overflow: hidden; clip-path: inset(50%); white-space: nowrap; }
